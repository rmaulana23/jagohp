...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <section id="privacy" className="flex-grow flex flex-col items-center justify-center pt-28 pb-12 px-4 sm:px-8 md:px-16 w-full">
        ...
        <div className="bg-gray-800/30 border border-cyan-400/30 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
          ...
          <div className="space-y-8">
            ...
            {policySections.map((section, index) => (
              <div key={index} className="border-t border-cyan-400/20 pt-6">
