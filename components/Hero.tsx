      ...
      <div className="relative z-10 text-center animate-fade-in w-full max-w-3xl">
        ...
        <form onSubmit={handleSearchSubmit} className="relative max-w-xl mx-auto mt-8">
            <input
                ...
                className="w-full bg-gray-900/50 border-2 border-indigo-500/50 rounded-full py-3 pl-6 pr-16 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition-all duration-300 text-base"
