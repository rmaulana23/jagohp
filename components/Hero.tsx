...
const AICore: React.FC = () => (
  <div className="absolute top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] h-[90vw] max-w-[600px] max-h-[600px] pointer-events-none -z-10">
  ...
  return (
    ...
    <section className="relative flex-grow flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 text-center animate-fade-in">
        <h1 className="font-orbitron text-5xl md:text-7xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-gray-200 via-white to-gray-300 drop-shadow-lg">
          Your AI Expert
          <br />
        ...
        <p className="max-w-2xl mx-auto mt-6 text-lg md:text-xl text-gray-300 font-light leading-relaxed">
          JAGO-HP solusi biar Kalian gak bingung atau salah beli HP.
        </p>

        <div className="flex flex-col sm:flex-row items-start justify-center gap-6 sm:gap-10 mt-10">
          <div className="flex flex-col items-center text-center">
            <button 
              onClick={openChat}
              className="font-orbitron text-lg font-bold w-64 h-14 rounded-full relative inline-flex items-center justify-center p-0.5 overflow-hidden
      ...
      {/* Social Proof Text */}
      <div className="absolute bottom-20 left-1/6 -translate-x-1/2 z-10 animate-fade-in-delayed">
