...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="flex-grow flex flex-col items-center justify-center pt-28 pb-12 px-4 sm:px-8 md:px-16">
      <div className="container mx-auto max-w-4xl animate-fade-in">
        <div className="bg-gray-800/30 border border-cyan-400/30 rounded-2xl p-8 md:p-12 backdrop-blur-sm text-center">
          <h1 className="font-orbitron text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-green-400">
            Tentang JAGO-HP
          </h1>
        ...
        <div className="mt-12 bg-gray-800/30 border border-cyan-400/30 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
