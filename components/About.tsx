  ...
  return (
    <section id="about" className="flex-grow flex flex-col items-center justify-center pt-24 pb-10 px-4 sm:px-6 md:px-12">
      <div className="container mx-auto max-w-4xl animate-fade-in">
        <div className="bg-gray-800/30 border border-indigo-500/30 rounded-2xl p-6 md:p-10 backdrop-blur-sm text-center">
          <h1 className="font-orbitron text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-fuchsia-400">
            Tentang JAGO-HP
          </h1>
        ...
        <div className="mt-10 bg-gray-800/30 border border-indigo-500/30 rounded-2xl p-6 md:p-10 backdrop-blur-sm">
          ...
          <ul className="space-y-4 max-w-2xl mx-auto">
            {missionPoints.map((point, index) => (
              <li key={index} className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-indigo-500/20 rounded-full flex items-center justify-center mr-4 mt-1">
